...
<a href="<?php echo WEB_ROOT; ?>my-account" class="w3-bar-item w3-button" onclick="showModalLoader()">My account</a>
...
<button class="w3-bar-item w3-button" onclick="showModalLoader()">Log out</button>
</form>
</div>
</span>
